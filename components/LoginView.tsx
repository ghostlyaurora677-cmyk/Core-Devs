  ...
  return (
    <div className="min-h-screen bg-[#050608] flex items-center justify-center px-6 selection:bg-indigo-600 selection:text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-xl relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <div className={`glass rounded-[4.5rem] p-12 md:p-24 border-white/5 shadow-[0_60px_120px_rgba(0,0,0,0.8)] relative overflow-hidden transition-all duration-1000 ${status === 'success' ? 'border-emerald-500/40 shadow-[0_0_100px_rgba(16,185,129,0.2)] scale-[1.02]' : ''}`}>
          ...
          <div className="relative z-20">
            {status !== 'success' ? (
              <>
                <div className="flex flex-col items-center mb-16 animate-in fade-in duration-700">
                  <div className={`w-28 h-28 rounded-[2.5rem] flex items-center justify-center text-white font-black text-4xl mb-10 transition-all duration-700 ${status === 'verifying' ? 'bg-indigo-600 shadow-[0_0_60px_rgba(79,70,229,0.6)] scale-110' : 'bg-white/5 border border-white/10 group-hover:border-white/20'}`}>CD</div>
                  ...
                  <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.4em] text-center max-w-[280px] leading-relaxed">
                    Accessing encrypted vaults requires personnel signature verification.
                  </p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-12">
                  <div className="space-y-5 animate-in slide-in-from-left-4 duration-700 [animation-delay:200ms]">
                    ...
                    <div className="relative group/input">
                      ...
                      <input 
                        ...
                        className={`w-full bg-white/5 border border-white/10 rounded-[2rem] pl-18 pr-8 py-7 text-white text-xl focus:outline-none focus:border-indigo-500 focus:bg-white/[0.08] transition-all font-bold tracking-tight disabled:opacity-50 ${status === 'verifying' ? 'cursor-wait' : ''}`}
                        placeholder="Personnel ID"
                      />
                    </div>
                  </div>

                  <div className="space-y-5 animate-in slide-in-from-left-4 duration-700 [animation-delay:400ms]">
                    ...
                    <div className="relative group/input">
                      ...
                      <input 
                        ...
                        className={`w-full bg-white/5 border border-white/10 rounded-[2rem] pl-18 pr-8 py-7 text-white text-xl focus:outline-none focus:border-indigo-500 focus:bg-white/[0.08] transition-all tracking-[0.4em] font-bold disabled:opacity-50 ${status === 'verifying' ? 'cursor-wait' : ''}`}
                        placeholder="••••••••"
                      />
                    </div>
                  </div>
                  ...
                  {error && (
                    <div className="flex items-center gap-5 px-8 py-6 rounded-[2rem] bg-red-500/10 border border-red-500/20 text-red-400 text-[10px] font-black uppercase tracking-[0.2em] animate-[glitch_0.4s_linear] relative overflow-hidden">
              ...
              <div className="py-20 flex flex-col items-center animate-in zoom-in-95 fade-in duration-700">
                <div className="w-40 h-40 rounded-[3.5rem] bg-emerald-500 flex items-center justify-center text-white mb-12 shadow-[0_0_80px_rgba(16,185,129,0.5)] animate-[pulse_2s_infinite]">
          ...
          <div className="mt-20 pt-12 border-t border-white/5 text-center">
            <p className="text-slate-600 text-[10px] font-black uppercase tracking-[0.3em] leading-relaxed max-w-[320px] mx-auto opacity-60">
              Protocol v4.9.2 Active. All session data is cryptographically audited for infrastructure integrity.
            </p>
          </div>
        </div>
      </div>
