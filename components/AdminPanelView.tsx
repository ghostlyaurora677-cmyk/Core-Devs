    ...
    <div className="min-h-screen bg-black text-white pt-24 px-6 pb-20 fade-in relative">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-4">
          {resources.map((res, index) => (
            ...
            >
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 rounded-[1.5rem] bg-white/5 flex items-center justify-center text-indigo-500">
                  {res.type === 'API_KEY' ? (
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" /></svg>
                  ) : res.type === 'CODE_SNIPPET' ? (
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
                  ) : (
          ...
          {resources.length === 0 && (
            <div className="text-center py-24 opacity-30 font-black uppercase tracking-widest text-xs flex flex-col items-center gap-6">
               <svg xmlns="http://www.w3.org/2000/svg" className="w-20 h-20 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
